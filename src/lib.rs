...
#[derive(Debug)]
pub struct ZephyrLoomProcessor {
    verbose: bool,
    processed_count: usize,
}

impl ZephyrLoomProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting ZephyrLoom processing");
    
    let mut processor = ZephyrLoomProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = ZephyrLoomProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = ZephyrLoomProcessor::new(false);
